...
ax1.plot(rates, T["lsu"], marker='.' ,label= "Simulated Throughput", linestyle=":", color = "blue", mfc="none")  # Plot the chart
ax1.plot(rates, _thrg["lsu"], marker='o' ,label= "Obtained Throughput", linestyle=":", color = "red", mfc="none")  # Plot the chart


ax2 = ax1.twinx()
ax2.set_ylabel("P99 E2E Delay (ms)", font)
ax2.plot(rates, L["lsu"], marker='x' ,label= "Simulated E2E Delay", linestyle="-.", color = "tab:blue", mfc="none")  # Plot the chart
ax2.plot(rates, _lats["lsu"], marker='s' , label= "Obtained E2E Delay", linestyle="-.", color = "tab:red", mfc="none")  # Plot the chart
ax1.set_xlim(2,20)
