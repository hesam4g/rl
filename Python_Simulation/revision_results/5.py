...
ax[0].plot(rate_128[::3], lats_128["prt"][::3], marker='o',label= "128-PRT", linestyle=":", color = "green", mfc="none")
ax[0].plot(rate_128[::3], lats_128["wrr"][::3], marker='^', label= "128-WRR", linestyle=":", color = "red", mfc="none")
ax[0].plot(rate_128[::3], lats_128["p4wise"][::3], 		marker='s' ,label= "128-P4Wise ($th = 0.6$)", linestyle="--", color = "blue", mfc="none")
ax[0].set_yscale('log')

ax[1].plot(rate_128[::3], thrg_128["prt"][::3], marker='o',label= "128-PRT", linestyle=":", color = "green", mfc="none")
ax[1].plot(rate_128[::3], thrg_128["wrr"][::3], marker='^', label= "128-WRR", linestyle=":", color = "red", mfc="none")
ax[1].plot(rate_128[::3], thrg_128["p4wise"][::3], 		marker='s' ,label= "128-P4Wise ($th = 0.6$)", linestyle="--", color = "blue", mfc="none")
ax[1].set_yscale('log')
...
# ax[0].set_ylabel("Latency (s)", font)
